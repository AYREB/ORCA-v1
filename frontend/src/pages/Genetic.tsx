...
import { Dna, Bookmark, AlertCircle } from "lucide-react";
...
const Genetic = () => {
  ...
  const handleSelectStrategy = (strategy: SavedStrategy) => setSelectedStrategy(strategy);
  ...
  return (
    <>
      <Helmet>
        <title>Genetic Optimizer - Orca</title>
        <meta name="description" content="Optimize your trading strategy with a genetic algorithm." />
      </Helmet>
          ...
          <div className="p-6 max-w-7xl mx-auto">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h1 className="text-2xl font-bold">Genetic Optimizer</h1>
                  <p className="text-muted-foreground text-sm">Run genetic search on a saved strategy</p>
                </div>
              </div>
            </motion.div>
                ...
                {selectedStrategy ? (
                  ...
                  >
                    ...
                    <p className="text-muted-foreground text-center max-w-md mb-4">
                      Select a saved strategy from the list to run the genetic optimizer.
                    </p>
