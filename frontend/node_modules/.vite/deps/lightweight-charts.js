...
function r(t, i2) {
  if (!t) throw new Error("Assertion failed" + (i2 ? ": " + i2 : ""));
}
function e(t) {
...
function w(t) {
  var i2;
  if ((t = t.toLowerCase()) in o && (t = o[t]), i2 = d.exec(t) || _.exec(t)) return [l(parseInt(i2[1], 10)), l(parseInt(i2[2], 10)), l(parseInt(i2[3], 10)), f(i2.length < 5 ? 1 : parseFloat(i2[4]))];
  if (i2 = v.exec(t)) return [l(parseInt(i2[1], 16)), l(parseInt(i2[2], 16)), l(parseInt(i2[3], 16)), 1];
  if (i2 = c.exec(t)) return [l(17 * parseInt(i2[1], 16)), l(17 * parseInt(i2[2], 16)), l(17 * parseInt(i2[3], 16)), 1];
...
var b = function(t, i2) {
  return b = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t2, i3) {
    ...
    for (var n2 in i3) Object.prototype.hasOwnProperty.call(i3, n2) && (t2[n2] = i3[n2]);
  }, b(t, i2);
};
function m(t, i2) {
...
var p = function() {
  return p = Object.assign || function(t) {
    for (var i2, n2 = 1, s2 = arguments.length; n2 < s2; n2++) for (var h2 in i2 = arguments[n2]) Object.prototype.hasOwnProperty.call(i2, h2) && (t[h2] = i2[h2]);
    return t;
  }, p.apply(this, arguments);
};
function g(t, i2, n2) {
  if (n2 || 2 === arguments.length) for (var s2, h2 = 0, r2 = i2.length; h2 < r2; h2++) !s2 && h2 in i2 || (s2 || (s2 = Array.prototype.slice.call(i2, 0, h2)), s2[h2] = i2[h2]);
...
function k(t) {
  ...
  for (var s2 = 0, h2 = i2; s2 < h2.length; s2++) {
    var r2 = h2[s2];
    for (var e2 in r2) void 0 !== r2[e2] && ("object" != typeof r2[e2] || void 0 === t[e2] ? t[e2] = r2[e2] : k(t[e2], r2[e2]));
  }
  return t;
}
function N(t) {
...
function T(t) {
  var i2, n2, s2, h2 = t;
  if (!h2 || "object" != typeof h2) return h2;
  for (n2 in i2 = Array.isArray(h2) ? [] : {}, h2) h2.hasOwnProperty(n2) && (s2 = h2[n2], i2[n2] = s2 && "object" == typeof s2 ? T(s2) : s2);
  return i2;
}
function D(t) {
  return null !== t;
...
var tt = (function(t) {
  function i2(i3, n2) {
    ...
    s2.Ii = (h2 = function() {
      ...
      var i4 = r2(), n3 = h2();
      if (t2 === u(s2.Di).ji()) return { et: n3, ti: i4 };
      var e3 = u(t2.kt());
      return { et: t2.qi(i4, e3), ti: i4 };
    });
    var e2 = /* @__PURE__ */ (function(t2, i4) {
      return function() {
...
function ht(t, i2) {
  if (!N(t)) return "n/a";
  if (!x(i2)) throw new TypeError("invalid length");
  if (i2 < 0 || i2 > 16) throw new TypeError("invalid length");
  if (0 === i2) return t.toString();
  return ("0000000000000000" + t.toString()).slice(-i2);
}
var rt = (function() {
  function t(t2, i2) {
    if (i2 || (i2 = 1), N(t2) && x(t2) || (t2 = 100), t2 < 0) throw new TypeError("invalid base");
  ...
  return t.prototype.format = function(t2) {
    ...
    if (this.Dn = 0, this._i > 0 && this.Cn > 0) for (var t2 = this._i; t2 > 1; ) t2 /= 10, this.Dn++;
    ...
    } else n2 = Math.round(n2 * i2) / i2, h2 > 0 && (s2 = st + ht(0, h2));
...
var ot = (function(t) {
  ...
  return m(i2, t), i2.prototype.Z = function(t2) {
    ...
    if (null !== this.X && 0 !== this.X.G.length && null !== this.X.J) {
      ...
      } else t2.moveTo(this.X.G[this.X.J.from].tt, this.X.En), t2.lineTo(this.X.G[this.X.J.from].tt, this.X.G[this.X.J.from].it), at(t2, this.X.G, this.X.Fn, this.X.J), this.X.J.to > this.X.J.from && (t2.lineTo(this.X.G[this.X.J.to - 1].tt, this.X.En), t2.lineTo(this.X.G[this.X.J.from].tt, this.X.En));
...
var ft = (function(t) {
  ...
  return m(i2, t), i2.prototype.Z = function(t2) {
    ...
    if (null !== this.X && 0 !== this.X.G.length && null !== this.X.J) if (t2.lineCap = "butt", t2.lineWidth = this.X.Vt, s(t2, this.X.Pt), t2.strokeStyle = this.zn(t2), t2.lineJoin = "round", 1 === this.X.G.length) {
      t2.beginPath();
      var i3 = this.X.G[0];
      t2.moveTo(i3.tt - this.X.Ln / 2, i3.it), t2.lineTo(i3.tt + this.X.Ln / 2, i3.it), void 0 !== i3.A && (t2.strokeStyle = i3.A), t2.stroke();
    } else this.Rn(t2, this.X);
...
var gt = (function() {
  ...
  return t.prototype.Z = function(t2) {
    ...
    if (null !== this.Bt && 0 !== this.Bt.an.length && null !== this.Bt.J) {
      if (this.Ms = this.ps(i2), this.Ms >= 2) Math.max(1, Math.floor(i2)) % 2 != this.Ms % 2 && this.Ms--;
...
var Lt = (function() {
  ...
  return t.prototype.Z = function(t2) {
    ...
    if (null !== this.Bt && 0 !== this.Bt.an.length && null !== this.Bt.J) {
      ...
      })(this.Bt.ws, i2), this.Ms >= 2) Math.floor(i2) % 2 != this.Ms % 2 && this.Ms--;
      var h2 = this.Bt.an;
    ...
    if (null !== this.Bt) for (var r2 = "", e2 = this.Is(h2), u2 = null, a2 = n2.from; a2 < n2.to; a2++) {
      var o2 = i2[a2];
      ...
      if (null !== u2 && (l2 = Math.max(u2 + 1, l2), l2 = Math.min(l2, f2)), this.Bt.ws * h2 > 2 * e2) j(t2, l2, c2, f2 - l2 + 1, v2 - c2 + 1, e2);
      else {
        var _2 = f2 - l2 + 1;
    ...
    if (null !== this.Bt) for (var h2 = "", r2 = this.Is(s2), e2 = n2.from; e2 < n2.to; e2++) {
  ...
  return t.prototype.Z = function(t2) {
    ...
    if (null !== this.Bt && 0 !== this.Bt.G.length && null !== this.Bt.J) {
      ...
      for (var s2 = this.Bt.J.from; s2 < this.Bt.J.to; s2++) {
        ...
        if (n2 % 2) u2 = e2 - (h2 = (n2 - 1) / 2), a2 = e2 + h2;
        else u2 = e2 - (h2 = n2 / 2), a2 = e2 + h2 - 1;
      ...
      if (i2 > 0 && f2 < 4) for (s2 = this.Bt.J.from; s2 < this.Bt.J.to; s2++) {
...
var Rt = (function() {
  ...
  return t.prototype.ih = function() {
    ...
    if (void 0 === r2) {
      if (0 === (r2 = t2.measureText(h2).width) && 0 !== i2.length) return 0;
...
var Zt = (function() {
  ...
  return t.prototype.Ph = function() {
    ...
    if (this.vt(), 2 === this.Vh.W().lastPriceAnimation) {
      ...
      if (i2 > 0) return void (i2 < 650 && (this.Oh += 2600));
...
var hi = (function(t) {
  ...
  return m(i2, t), i2.prototype.Z = function(t2) {
    ...
    for (var n2 = this.Bt.J.from; n2 < this.Bt.J.to; n2++) {
      var s2 = this.Bt.G[n2];
      if (ei(s2, t2, i3)) return { Kh: s2.Xh, Zh: s2.Zh };
    }
    return null;
...
var di = (function() {
  ...
  return t.prototype.Pr = function(t2) {
    ...
    if (t2.jt().bt().wi() || i2.wi()) return null;
    var n2 = t2.kt();
...
var gi = (function(t) {
  ...
  return m(i2, t), i2.prototype.g = function() {
    ...
    if (this.jt().bt().wi() || n2.wi() || this.Bt.wi()) return i3;
    var s2, h2, r2 = this.jt().bt().ss(), e2 = this.kt();
    if (null === r2 || null === e2) return i3;
    if (t2) {
      var u2 = this.Bt.Gr();
      if (null === u2) return i3;
      s2 = u2, h2 = u2.vs;
    } else {
      var a2 = this.Bt.ne(r2.jn(), -1);
      if (null === a2) return i3;
      if (null === (s2 = this.Bt.Kr(a2.vs))) return i3;
      h2 = a2.vs;
    }
    ...
    if (!x(t2) || !x(i3) || this.Bt.wi()) return null;
...
var yi = (function() {
  ...
  return t.prototype.Je = function(t2, i2, n2) {
    ...
    var e2 = h2.xt(t2, r2), u2 = n2.Ge().filter((function(t3) {
      ...
      if (n2.lh(s3) || !s3.yt()) return t3;
      var h3 = s3.Ct(), r3 = s3.an();
      if (h3.wi() || !r3.Uh(i2)) return t3;
      var e3 = r3.Kr(i2);
      if (null === e3) return t3;
      var u3 = a(s3.kt());
      return t3.concat([h3.xt(e3.St[3], u3.St)]);
    }), []);
    if (0 === u2.length) return s2;
...
var Pi = (function() {
  function t(t2, i2) {
    if (this.cu = t2, this.vu = i2, (function(t3) {
      ...
      for (var i3 = t3; i3 > 1; i3 /= 10) if (i3 % 10 != 0) return false;
      return true;
    })(this.cu)) this._u = [2, 2.5, 2];
    else {
      this._u = [];
      for (var n2 = this.cu; 1 !== n2; ) {
        if (n2 % 2 == 0) this._u.push(2), n2 /= 2;
        else {
          if (n2 % 5 != 0) throw new Error("unexpected base");
  ...
  return t.prototype.du = function(t2, i2, n2) {
    ...
    if (u2 <= e2 + 1e-14 && (u2 = e2), u2 = Math.max(1, u2), this._u.length > 0 && (s2 = u2, h2 = 1, r2 = 1e-14, Math.abs(s2 - h2) < r2)) for (a2 = 0, o2 = this._u[0]; xt(u2, n2 * o2, 1e-14) && u2 > e2 + 1e-14; ) u2 /= o2, o2 = this._u[++a2 % this._u.length];
    return u2;
  }, t;
})();
var Wi = (function() {
  ...
  return t.prototype.du = function(t2, i2) {
    ...
    return u2.push(h2.du(t2, i2, s2), r2.du(t2, i2, s2), e2.du(t2, i2, s2)), (function(t3) {
      ...
      for (var i3 = t3[0], n3 = 1; n3 < t3.length; ++n3) t3[n3] < i3 && (i3 = t3[n3]);
      return i3;
    })(u2);
...
var ji = (function() {
  ...
  return t.prototype.Ke = function() {
    ...
    if (k(this.zi, t2), this.Xe(), void 0 !== t2.mode && this.$u({ mh: t2.mode }), void 0 !== t2.scaleMargins) {
      ...
      if (i2 < 0 || i2 > 1) throw new Error("Invalid top margin - expect value between 0 and 1, given=".concat(i2));
      if (n2 < 0 || n2 > 1 || i2 + n2 > 1) throw new Error("Invalid bottom margin - expect value between 0 and 1, given=".concat(n2));
      if (i2 + n2 > 1) throw new Error("Invalid margins - sum of margins must be less than 1, given=".concat(i2 + n2));
    ...
    var t2 = null === this.kt();
    if (null !== this.Pu && (t2 || this.Pu.va === t2)) return this.Pu.au;
    this.Uu.pu();
    var i2 = this.Uu.au();
    ...
    if (null !== t2) {
      ...
      if (h2 === this.Bu && r2 === this.Lu || (this.Bu = h2, this.Lu = r2, this.Pu = null, this.Ku()), null !== s2) {
        ...
        this.Gu(s2);
      } else null === this.Tr && (this.Gu(new fi(-0.5, 0.5)), this.Ru = Oi(null));
      this.Tu.Du = true;
    }
...
var qi = (function() {
  ...
  return t.prototype.Oa = function(t2) {
    if (t2.leftPriceScale && this.Ba.Pr(t2.leftPriceScale), t2.rightPriceScale && this.Ea.Pr(t2.rightPriceScale), t2.localization && (this.Ba.Xe(), this.Ea.Xe()), t2.overlayPriceScales) for (var i2 = 0, n2 = Array.from(this.Ca.values()); i2 < n2.length; i2++) {
      var s2 = u(n2[i2][0].Ct());
    ...
    var t2 = this.oa();
    if (0 === t2.length) return { uo: 0, ja: 0 };
...
var sn = (function() {
  ...
  return t.prototype.W = function() {
    ...
    if (t2.So > this.Yo[this.Yo.length - 1].rt.So) return i2 ? this.Yo.length - 1 : null;
    ...
    var n2 = this;
    if (void 0 === i2 && (i2 = 400), !isFinite(t2)) throw new RangeError("offset is required and must be finite number");
    ...
    if (this.Zo) if (this.Zo = false, this.wi()) this.Ul(nn.Uo());
    else {
...
var fn = (function() {
  ...
  return t.prototype.Ce = function() {
    ...
    if (i2 === n2) return i2;
    if (t2 = Math.max(0, Math.min(100, Math.round(100 * t2))), null === this.lf || this.lf.Pn !== n2 || this.lf.Wn !== i2) this.lf = { Pn: n2, Wn: i2, Jf: /* @__PURE__ */ new Map() };
    else {
...
var yn = (function() {
  ...
  return t.prototype.lc = function(t2, i2) {
    if (null !== this.Qf) {
      if (this.Qf.rt === i2) return void (this.Qf.Gf = t2);
      if (Math.abs(this.Qf.Gf - t2) < this.Cn) return;
    }
    ...
    if (null !== this.Qf && null !== this.tc && !(i2 - this.Qf.rt > 50)) {
      ...
      for (var f2, c2, v2, _2 = 0, d2 = 0; d2 < r2.length; ++d2) _2 += e2[d2] / n2 * r2[d2];
      if (!(Math.abs(_2) < this.uc)) this.sc = { Gf: t2, rt: i2 }, this.rc = _2, this.hc = (f2 = Math.abs(_2), c2 = this.oc, v2 = Math.log(c2), Math.log(1 * v2 / -f2) / v2);
    }
...
var Sn = (function() {
  function t(t2, i2, n2) {
    ...
    this.wc = 0, this.Mc = null, this.bc = { tt: Number.NEGATIVE_INFINITY, it: Number.POSITIVE_INFINITY }, this.mc = 0, this.gc = null, this.yc = { tt: Number.NEGATIVE_INFINITY, it: Number.POSITIVE_INFINITY }, this.kc = null, this.Nc = false, this.xc = null, this.Cc = null, this.Sc = false, this.Tc = false, this.Dc = false, this.Ac = null, this.Bc = null, this.Lc = null, this.Ec = null, this.Fc = null, this.Oc = null, this.Vc = null, this.Pc = 0, this.Wc = false, this.zc = false, this.Rc = false, this.Ic = 0, this.jc = null, this.qc = !xn(), this.Uc = function(t3) {
      ...
      if (s2.$c(t3)) {
        var i3 = s2.Kc(t3);
        if (++s2.mc, s2.gc && s2.mc > 1) s2.Zc(An(t3), s2.yc).Xc < 30 && !s2.Dc && s2.Jc(i3, s2.Qc.Gc), s2.tv();
      } else {
        i3 = s2.Kc(t3);
        if (++s2.wc, s2.Mc && s2.wc > 1) s2.Zc(An(t3), s2.bc).Xc < 5 && !s2.Tc && s2.iv(i3, s2.Qc.nv), s2.sv();
      }
  ...
  return t.prototype.g = function() {
    ...
    if (null === i2 && 0 === t2.touches.length && (i2 = t2.changedTouches[0]), null !== i2) {
      ...
      if (this.Jc(n2, this.Qc.pv), ++this.mc, this.gc && this.mc > 1) this.Zc(An(i2), this.yc).Xc < 30 && !this.Dc && this.Jc(n2, this.Qc.Gc), this.tv();
      else this.Dc || (this.Jc(n2, this.Qc.gv), this.Qc.gv && Dn(t2));
      0 === this.mc && Dn(t2), 0 === t2.touches.length && this.Nc && (this.Nc = false, Dn(t2));
    }
  }, t.prototype.Hc = function(t2) {
    if (0 === t2.button) {
      var i2 = this.Kc(t2);
      if (this.xc = null, this.Rc = false, this.Fc && (this.Fc(), this.Fc = null), Nn()) this.hv.ownerDocument.documentElement.removeEventListener("mouseleave", this.Uc);
      if (!this.$c(t2)) if (this.iv(i2, this.Qc.yv), ++this.wc, this.Mc && this.wc > 1) this.Zc(An(t2), this.bc).Xc < 5 && !this.Tc && this.iv(i2, this.Qc.nv), this.sv();
      else this.Tc || this.iv(i2, this.Qc.kv);
    }
...
function Ln(t, i2) {
  for (var n2 = 0; n2 < t.length; ++n2) if (t[n2].identifier === i2) return t[n2];
  return null;
}
var En = (function() {
  function t(t2, i2, n2, s2) {
  ...
  return t.prototype.g = function() {
    ...
    var n2, s2 = this;
    if (this.h_.has(i2)) n2 = e(this.h_.get(i2));
    else {
...
var Fn = (function() {
  ...
  return t.prototype.g = function() {
    ...
    if (t2.Ft < 0 || t2.Ot < 0) throw new Error("Try to set invalid size to PriceAxisWidget " + JSON.stringify(t2));
    ...
    return (function(s2) {
      for (var h2 = 0; h2 < s2.length; ++h2) for (var r2 = s2[h2].nn(t2.Di.z_(), n2), e2 = 0; e2 < r2.length; e2++) i2.push(r2[e2]);
    })(this.Di.z_().oa()), i2;
...
var zn = (function() {
  ...
  return t.prototype.g = function() {
    ...
    for (var s2 = 0, h2 = n2.oa(); s2 < h2.length; s2++) {
      ...
      if (null !== e2) return { kf: r2, i_: e2.i_, yd: e2.yd };
    }
    return null;
    ...
    if (t2.Ft < 0 || t2.Ot < 0) throw new Error("Try to set invalid size to PaneWidget " + JSON.stringify(t2));
    ...
    if (this.G_) {
      ...
      if (null !== this.ed && this.ed.xh(t2.Yv, n2), null === this.ed || this.ed.cc(n2)) this.Ud();
      else {
...
var Rn = (function() {
  ...
  return t.prototype.g = function() {
    ...
    if (t2.Ft < 0 || t2.Ot < 0) throw new Error("Try to set invalid size to PriceAxisStub " + JSON.stringify(t2));
...
var jn = (function() {
  ...
  return t.prototype.g = function() {
    ...
    for (var s2 = this.uw(), h2 = 0, r2 = t2; h2 < r2.length; h2++) for (var e2 = 0, u2 = r2[h2].Ti(); e2 < u2.length; e2++) {
      var a2 = u2[e2];
...
var qn = (function() {
  ...
  return t.prototype.jt = function() {
    ...
    for (var i2 = 0; i2 < this._w.length; i2++) this._w[i2].R_(t2.wn(i2).vn);
    ...
    for (var i2 = this.pi.Cf(), n2 = 0; n2 < i2.length; n2++) t2.wn(n2)._n && i2[n2].so();
  }, t.prototype.xn = function(t2) {
    var i2 = this.pi.bt();
    switch (t2.bn) {
      case 0:
...
function ts(t, i2) {
  if (t.getUTCFullYear() !== i2.getUTCFullYear()) return 70;
  if (t.getUTCMonth() !== i2.getUTCMonth()) return 60;
  if (t.getUTCDate() !== i2.getUTCDate()) return 50;
  for (var n2 = Qn.length - 1; n2 >= 0; --n2) if (Math.floor(i2.getTime() / Qn[n2].Hw) !== Math.floor(t.getTime() / Qn[n2].Hw)) return Qn[n2].Po;
  return 0;
}
function is(t, i2) {
...
function es(t) {
  var i2 = new Date(t);
  if (isNaN(i2.getTime())) throw new Error("Invalid date string=".concat(t, ", expected format=yyyy-mm-dd"));
...
function os(t) {
  if (void 0 !== t && 0 !== t.length) return { $w: t[0].rt.So, Kw: t[t.length - 1].rt.So };
}
var ls = (function() {
  function t() {
  ...
  return t.prototype.g = function() {
    ...
    if (void 0 !== r2) if (1 === this.Zw.size) s2 = false, h2 = true, this.Xw.clear();
    else for (var e2 = 0, a2 = this.Gw; e2 < a2.length; e2++) {
    ...
    return this.sM(t2, c2, (function(t3, i3) {
      ...
      if (void 0 !== n3 && void 0 !== s3) return { Ae: n3.Kw >= s3.Kw && n3.$w >= s3.$w };
    })(this.Zw.get(t2), r2));
  }, t.prototype.Yf = function(t2) {
    return this.Qw(t2, []);
    ...
    if (void 0 !== s2 && n2.So < s2.So) throw new Error("Cannot update oldest data, last time=".concat(s2.So, ", new time=").concat(n2.So));
    ...
    if (-1 === i2 && this.Gw.length !== t2.length && (i2 = Math.min(this.Gw.length, t2.length)), -1 === i2) return -1;
    for (n2 = i2; n2 < t2.length; ++n2) fs(t2[n2].pointData, n2);
    ...
    if (-1 !== i2) this.Zw.forEach((function(i3, h3) {
...
function _s(t) {
  var i2 = t.overlay, n2 = (function(t2, i3) {
    var n3 = {};
    for (var s2 in t2) Object.prototype.hasOwnProperty.call(t2, s2) && i3.indexOf(s2) < 0 && (n3[s2] = t2[s2]);
    if (null != t2 && "function" == typeof Object.getOwnPropertySymbols) {
      var h2 = 0;
      for (s2 = Object.getOwnPropertySymbols(t2); h2 < s2.length; h2++) i3.indexOf(s2[h2]) < 0 && Object.prototype.propertyIsEnumerable.call(t2, s2[h2]) && (n3[s2[h2]] = t2[s2[h2]]);
    }
    return n3;
  })(t, ["overlay"]);
...
var ds = (function() {
  ...
  return t.prototype.priceFormatter = function() {
    ...
    if (n2.wi()) return null;
    var s2 = n2.ne(i2.In(), 1), h2 = n2.ne(i2.jn(), -1), r2 = u(n2.Qr()), e2 = u(n2.un());
    if (null !== s2 && null !== h2 && s2.vs > h2.vs) return { barsBefore: t2.from - r2, barsAfter: e2 - t2.to };
  ...
  if (void 0 !== t && "custom" !== t.type) {
    ...
    void 0 !== i2.minMove && void 0 === i2.precision && (i2.precision = (function(t2) {
      ...
      for (var i3 = 0; i3 < 8; i3++) {
        ...
        if (Math.abs(n2 - t2) < 1e-8) return i3;
        t2 *= 10;
      }
      return i3;
    })(i2.minMove));
